...
import { ArrowLeft, AlertCircle, Palette, Save } from 'lucide-react'
...
// remove the infousing the index
  ...
  // handle delete resume
    ...
    try {
      await html2pdf()
        ...
        .from(element)
        .save(); //save resume and will be downloaded
  ...
  // so all this function will br use for rsume
    ...
    <DashboardLayout>
      <div className={containerStyles.main}>
        <div className={containerStyles.header}  >
            ...
            setTitle={(value) => setResumeData((prev) => ({ ...prev , 
                title:value
            }))
        } />
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="flex flex-wrap items-center justify-end gap-3">
                ...
                <button className={buttonStyles.next} onClick={validateAndNext} disabled={isLoading}>
                  ...
                  {currentPage === "additionalInfo" ? "Download PDF" : "Next"}
        ...
        {/* modal data here */ }
        <Model isOpen={openThemeSelector} onClose={() => setOpenThemeSelector(false)} title="change Title" >
