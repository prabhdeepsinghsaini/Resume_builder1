...
const Dashboard = () => {
  ...
  // it will show if completion it will do ++
  ...
  const handleDelelteResume = async () => {
  ...
  return (
    <DashboardLayout>
        ...
        {!loading && allResumes.length === 0 && (
          <div className={styles.emptyStateWrapper} >
            ...
            <p className={styles.emptyText} >
              you haven't created any resumes yet. Start by clicking the button below to create your first resume.
            </p>
      ...
      hideHeader maxWidth="max-w-2xl" >
        <div className='p-6'  >
          <div className={styles.modalHeader}  >
            <h3 className={styles.modalTitle}  >Select a Template</h3>
      ...
      onActionClick={handleDelelteResume}>
        <div className='p-4'>
